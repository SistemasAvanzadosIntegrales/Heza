urlEliminar='/coeficiente/eliminar';
...
function cargaGridfrmCoeficiente() {
	...
	$("#flexigrid").flexigrid({
		...
		colModel: [
			...
			{display: "Coeficiente de utilidad", name: "coeficiente_utilidad", width: 180, sortable: true, align: "center"},
		],
		sortname: "id_empresa"
		,sortorder: "asc"
		,usepager: true
