...
abstract class BaseEmpresa extends Doctrine_Record {
	...
	public function setTableDefinition() {
		...
		$this->hasColumn('ejercicio_anterior_enero_febrero_1', 'float', 20, array(
			 'type' => 'float',
			 'notnull' => true,
			 'length' => '20',
			 ));
		$this->hasColumn('ejercicio_anterior_enero_febrero_2', 'float', 20, array(
			 'type' => 'float',
			 'notnull' => true,
			 'length' => '20',
			 ));
		$this->hasColumn('ejercicio_anterior_marzo_diciembre_1', 'float', 20, array(
			 'type' => 'float',
			 'notnull' => true,
			 'length' => '20',
			 ));
		/*
		$this->hasColumn('ejercicio_anterior_2_febrero', 'float', 20, array(
			 'type' => 'float',
			 'notnull' => true,
			 'length' => '20',
			 ));
